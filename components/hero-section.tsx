...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-[85vh] lg:min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="relative z-10 w-full px-6 pt-16 pb-4 lg:pt-20 lg:pb-16">
        <div className="max-w-2xl lg:ml-12 xl:ml-24">
          ...
          <div className="space-y-2 lg:space-y-4 mb-4 lg:mb-10">
            ...
            <div className="flex items-start gap-2 lg:gap-3 text-white/90">
              <Check className="w-5 h-5 lg:w-6 lg:h-6 text-primary flex-shrink-0 mt-0.5 lg:mt-1" />
              <p className="text-base md:text-xl leading-snug lg:leading-relaxed">Бесплатный выезд оценщика в любую точку Беларуси</p>
            </div>
            <div className="flex items-start gap-2 lg:gap-3 text-white/90">
              <Check className="w-5 h-5 lg:w-6 lg:h-6 text-primary flex-shrink-0 mt-0.5 lg:mt-1" />
              <p className="text-base md:text-xl leading-snug lg:leading-relaxed">Сами оформим все документы</p>
            </div>
          </div>
          ...
          <div className="space-y-2 lg:space-y-4">
            ...
            >
              <div className="bg-primary/20 p-2 lg:p-3 rounded-2xl group-hover:bg-primary/30 transition-colors">
                <Phone className="w-5 h-5 lg:w-6 lg:h-6 text-primary" />
              </div>
              <span className="text-xl md:text-3xl font-bold">+375 (44) 5-419-419</span>
            </a>
